# msfr640-editioncrafter-data

This is a forked repository from [editioncrafter-data](https://github.com/cu-mkp/editioncrafter-data), with example files of M&K's manuscript of study, BnF Ms. Fr. 640. Of the 170 folios, only the first five folios (fols. 1r-5v) have been included.
